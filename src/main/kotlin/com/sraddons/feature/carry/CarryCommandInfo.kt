...
internal object CarryCommandInfo {
                ...
                if (CarryState.clients.isEmpty()) {
                    ...
                    CarryState.clients.values.forEach { client ->
                        context.source.sendFeedback(
                            Component
                                .translatable(
                                    "sraddons.carry.client_list_entry",
            ...
            .executes { context ->
                ...
                if (CarryState.types.isEmpty()) {
                    ...
                    CarryState.types.values.forEach { type ->
                        ...
                        context.source.sendFeedback(
                            Component.translatable(
                                "sraddons.carry.type_list_entry",
            ...
            .executes { context ->
                ...
                if (s.totalOrders == 0 && s.totalCarries == 0 && s.totalEarned == 0L) {
                    ...
                    context.source.feedback(
                        Component
                            .translatable(
                                "sraddons.carry.earnings_summary",
            ...
            source.feedback(
                Component
                    .translatable(
                        ...
                        Component.literal(clientCount.toString()).withColor(0xFFFFFF),
                    ).withColor(0xFF5555),
            )
            return
        }
    ...
    private fun calcPriceForClient(
        ...
        if (usingBulk) {
            source.feedback(
                Component.translatable(
                    "sraddons.carry.calc_price.bulk",
            ...
            source.feedback(
                Component.translatable(
                    "sraddons.carry.calc_price.standard",
                    Component.literal(client.amount.toString()).withColor(0x55FFFF),
                    Component.literal(CarryPriceUtil.formatPrice(unitPrice)).withColor(0xFFAA00),
                    Component.literal(CarryPriceUtil.formatPrice(total)).withColor(0xFFFFFF),
                ),
