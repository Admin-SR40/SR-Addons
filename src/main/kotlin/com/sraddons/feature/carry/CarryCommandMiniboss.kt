...
internal object CarryCommandMiniboss {
                    ...
                    .executes { context ->
                        ...
                        if (CarryState.minibossNames.any { it.equals(name, ignoreCase = true) }) {
                            context.source.feedback(
                                Component
                                    .translatable(
                                        "sraddons.carry.miniboss_already_exists",
    ...
    fun removeMinibossNode() =
        ClientCommands
            .literal("remove-miniboss")
            .then(
                ClientCommands
                    .argument("name", StringArgumentType.string())
                    ...
                    .executes { context ->
                        ...
                        if (CarryState.minibossNames.none { it.equals(name, ignoreCase = true) }) {
                            context.source.feedback(
                                Component
                                    .translatable(
                                        "sraddons.carry.miniboss_not_found",
                                        Component.literal(name).withColor(0x55FFFF),
                                    ).withColor(0xFF5555),
                            )
                            return@executes 1
                        ...
                        context.source.feedback(
                            Component
                                .translatable(
                                    "sraddons.carry.miniboss_removed",
                                    Component.literal(name).withColor(0x55FFFF),
                                ).withColor(0x55FF55),
                        )
                        1
