...
internal object CarryCommandManagement {
    ...
    fun removeAmountNode() =
        ClientCommands
            .literal("remove-amount")
            .then(
                ClientCommands
                    .argument("playerName", StringArgumentType.word())
                    .suggests(suggestClients)
                    ...
                    .then(
                        ClientCommands
                            ...
                            .executes { context ->
                                ...
                                ClientCommands
                                    .argument("useBulk", BoolArgumentType.bool())
                                    .executes { context ->
                                        if (!context.source.requireEnabled()) return@executes 1
                                        CarryState.saveUndo()
                                        val playerName = StringArgumentType.getString(context, "playerName")
    ...
    fun removeClientNode() =
        ClientCommands
            .literal("remove-client")
            .then(
                ClientCommands
                    .argument("playerName", StringArgumentType.word())
                    .suggests(suggestClients)
                    .executes { context ->
                        ...
                        context.source.feedback(
                            Component
                                .translatable(
                                    "sraddons.carry.client_removed",
                                    Component.literal(removed.playerName).withColor(0xFF55FF),
                                ).withColor(0x55FF55),
                        )
                        1
                    },
            ...
            .then(
                ClientCommands
                    ...
                    .executes { context ->
                        ...
                        val referencingClients =
                            CarryState.clients.values.filter {
