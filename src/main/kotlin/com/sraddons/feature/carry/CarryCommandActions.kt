...
internal object CarryCommandActions {
    ...
    private fun doneWithDefaultAmount(
        ...
        when (CarryState.clients.size) {
            ...
            1 -> {
                executeDone(source, amount, CarryState.clients.values.first())
            }
    ...
    private fun executeDone(
        ...
        if (client.completed >= client.amount) {
            ...
            source.feedback(
                Component.translatable(
                    "sraddons.carry.progress_detail",
