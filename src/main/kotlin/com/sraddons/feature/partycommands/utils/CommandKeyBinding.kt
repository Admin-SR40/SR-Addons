    ...
    fun init() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register { client ->
            ...
            while (toggleKey.consumeClick()) {
                ...
                SRConfig.save()
                val enabled = SRConfig.settings.partyCommands.enabled
                val statusKey = if (enabled) "sraddons.key.toggle.enabled" else "sraddons.key.toggle.disabled"
