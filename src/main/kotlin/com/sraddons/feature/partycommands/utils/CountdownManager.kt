...
object CountdownManager {
        ...
        if (label == CUSTOM_LABEL) {
            if (PartyUtils.isInParty) {
                sendPartyChat(
                    Component
                        .translatable(
                            "sraddons.pc.countdown.started.party",
                ...
                modMessage(
                    formatResponse(
                        ...
                        Component
                            .translatable(
                                "sraddons.pc.countdown.started",
                                Component.literal("$timeStr ($displayLabel)"),
                            ).withColor(0x55FF55),
                    ),
                )
            }
            ...
            if (PartyUtils.isInParty) {
                sendPartyChat(
                    Component
                        .translatable(
                            "sraddons.pc.countdown.party.queued",
                            Component.literal(displayLabel),
                            Component.literal(timeStr),
                        ).string,
                )
        ...
        if (countdown.remainingSeconds <= 0) {
            ...
            if (PartyUtils.isInParty) {
                sendPartyChat(
                    Component
                        .translatable(
                            "sraddons.pc.countdown.times_up",
                            Component.literal(countdown.label),
                        ).string,
                )
            } else {
                modMessage(
                ...
                if (instanceId != null) {
                    ...
                    modMessage(
                        formatResponse(
                            ...
                            Component
                                .translatable(
                                    "sraddons.pc.countdown.auto_join",
                                    Component.literal(countdown.label),
                                ).withColor(0xFFFF55),
                        ),
                    )
        ...
        if (countdown.label == CUSTOM_LABEL) {
            if (PartyUtils.isInParty) {
                sendPartyChat(
                    Component
                        .translatable(
                            "sraddons.pc.countdown.party.remaining",
            ...
            if (PartyUtils.isInParty) {
                ...
                modMessage(
                    formatResponse(
                        ...
                        Component
                            .translatable(
                                "sraddons.pc.countdown.remaining",
                                Component.literal(timeStr),
                                Component.literal(countdown.label),
                            ).withColor(color),
                    ),
    ...
    fun tryCancelFromPartyChat(playerName: String): Boolean {
        ...
        sendPartyChat(
            Component
                .translatable(
                    "sraddons.pc.countdown.cancelled_by",
