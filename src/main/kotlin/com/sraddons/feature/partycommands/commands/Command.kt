...
abstract class Command(
    ...
    companion object {
        ...
        fun <T> argument(
            name: String,
            type: ArgumentType<T>,
        ): RequiredArgumentBuilder<SharedSuggestionProvider, T> = RequiredArgumentBuilder.argument(name, type)

        fun literal(name: String): LiteralArgumentBuilder<SharedSuggestionProvider> = LiteralArgumentBuilder.literal(name)
    }
