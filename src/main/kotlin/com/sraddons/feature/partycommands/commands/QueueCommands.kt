...
import com.sraddons.feature.partycommands.utils.FloorData
                                    ...
                                    if (SRConfig.isCommandEnabled(cmd)) {
                                        ...
                                        if (seconds != null && seconds > 0) {
                                            ...
                                            respond(
                                                formatResponse(
                                                    label("error"),
                                                    Component.translatable("sraddons.pc.queue.invalid_time").withColor(0xFF5555),
                                                ),
                                            )
                                        }
                                    } else {
                            ...
                            if (SRConfig.isCommandEnabled(cmd)) {
                                ...
                                respond(
                                    formatResponse(
                                        ...
                                        Component.literal("§e${cmd.uppercase()}"),
                                    ),
                                )
