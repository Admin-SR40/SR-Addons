...
object SRConfigGui {
    ...
    private val PC_TOGGLE_GROUPS =
        listOf(
            CommandToggleGroup(
                "sraddons.gui.pc.group.party_mgmt",
                "sraddons.gui.pc.group.party_mgmt.desc",
                listOf(
                    "warp",
                    "allinvite",
                    "kick",
            ...
            CommandToggleGroup(
                "sraddons.gui.pc.group.queue.f",
                "sraddons.gui.pc.group.queue.f.desc",
                listOf("f1", "f2", "f3", "f4", "f5", "f6", "f7"),
            ),
            CommandToggleGroup(
                "sraddons.gui.pc.group.queue.m",
                "sraddons.gui.pc.group.queue.m.desc",
                listOf("m1", "m2", "m3", "m4", "m5", "m6", "m7"),
            ),
            CommandToggleGroup(
                "sraddons.gui.pc.group.queue.t",
                "sraddons.gui.pc.group.queue.t.desc",
                listOf("t1", "t2", "t3", "t4", "t5"),
            ),
            CommandToggleGroup(
                "sraddons.gui.pc.group.info",
                "sraddons.gui.pc.group.info.desc",
                listOf("ping", "tps", "fps", "time", "location", "coords", "holding", "status", "countdown"),
            ),
            CommandToggleGroup(
                "sraddons.gui.pc.group.fun",
                "sraddons.gui.pc.group.fun.desc",
    ...
    private fun createPCDelaysGroup(): OptionGroup {
        ...
        return OptionGroup
            ...
            .option(
                intOpt("pc.update_cooldown", 60000, 5000, 300000, 5000, { pc.partyListUpdateCooldownMs }, {
                    pc.partyListUpdateCooldownMs =
                        it
                }),
            ).option(
                intOpt("pc.update_init_delay", 500, 100, 5000, 100, { pc.partyListInitialDelayMs }, { pc.partyListInitialDelayMs = it }),
            ...
            builder.option(
                Option
                    ...
                    .binding(
                        ...
                        { enabled ->
                            if (enabled) {
                                SRConfig.settings.partyCommands.disabledCommands.remove(
                                    cmd,
                                )
                            } else {
                                SRConfig.settings.partyCommands.disabledCommands
                                    .add(cmd)
                            }
                        },
                    ).controller(TickBoxControllerBuilder::create)
        ...
        return OptionGroup
            ...
            .option(
                colorOpt(
                    ...
                    20,
                    200,
                    { c.clientHighlight.toColor() },
                    { r, g, b, a ->
                        c.clientHighlight.colorRed = r
                        c.clientHighlight.colorGreen = g
                        c.clientHighlight.colorBlue =
                            b
                        c.clientHighlight.colorAlpha = a
                    },
                ),
            ...
            .option(
                colorOpt(
                    ...
                    50,
                    200,
                    { c.bossHighlight.toColor() },
                    { r, g, b, a ->
                        c.bossHighlight.colorRed = r
                        c.bossHighlight.colorGreen = g
                        c.bossHighlight.colorBlue =
                            b
                        c.bossHighlight.colorAlpha = a
                    },
                ),
            ).option(
                boolOpt("carry.miniboss_highlight", true, {
                    c.minibossHighlight.enabled
                }, { c.minibossHighlight.enabled = it }),
            ).option(
                colorOpt(
                    "carry.miniboss_color",
                    255,
                    165,
                    0,
                    200,
                    { c.minibossHighlight.toColor() },
                    { r, g, b, a ->
                        c.minibossHighlight.colorRed = r
                        c.minibossHighlight.colorGreen = g
                        c.minibossHighlight.colorBlue =
                            b
                        c.minibossHighlight.colorAlpha = a
                    },
                ),
            ).build()
    }
    ...
    private fun createBossNotificationGroup(): OptionGroup {
        ...
        return OptionGroup
            ...
            .option(
                strOpt("carry.boss_notification_text", "&cBOSS SPAWNED", { c.bossSpawnNotificationText }, {
                    c.bossSpawnNotificationText =
                        it
                }),
            ).option(
                intOpt("carry.boss_uuid_prune", 1200, 100, 72000, 100, {
                    c.bossUuidPruneInterval
                }, { c.bossUuidPruneInterval = it }),
            ).build()
    }
    ...
    private fun createMinibossDistanceGroup(): OptionGroup {
        ...
        return OptionGroup
            ...
            .collapsed(true)
            .option(
                intOpt("carry.miniboss_max_distance", 16, 4, 32, 1, { c.minibossMaxDistance }, {
                    c.minibossMaxDistance =
                        it.coerceIn(4, 32)
                }),
            ).build()
    }
    ...
    private fun createChatAlertList() =
        ListOption
            .createBuilder<String>()
