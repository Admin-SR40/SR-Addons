...
<p align="center">
  ...
  <a href="https://github.com/Admin-SR40/SR-Addons/releases/latest"><img src="https://img.shields.io/badge/Version-1.5.5-orange" alt="Version"></a>
</p>
...
6. Download `SR-Addons-1.5.5.jar` and place it in `.minecraft/mods/`
...
**Requirements:** JDK 21  
**Output:** `build/libs/SR-Addons-1.5.5.jar`
